...
exports.registerUser = async (req, res) => {
  try {
    ...
    await sendEmail({
      email,
      subject: 'Enjoy Booking - Email Verification',
      html: `
        <h1>Welcome to Enjoy Booking!</h1>
    ...
    await sendSMS({
      to: mobileNumber,
      body: `Your Enjoy Booking verification code is: ${mobileOTP}. This code is valid for 10 minutes.`
    });
...
exports.registerHost = async (req, res) => {
  try {
    ...
    await sendEmail({
      email,
      subject: 'Enjoy Booking - Host Email Verification',
      html: `
        <h1>Welcome to Enjoy Booking!</h1>
    ...
    await sendSMS({
      to: mobileNumber,
      body: `Your Enjoy Booking host verification code is: ${mobileOTP}. This code is valid for 10 minutes.`
    });
